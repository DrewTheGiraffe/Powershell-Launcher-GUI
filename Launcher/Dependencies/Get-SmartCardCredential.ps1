# Major Credits too jimmy58663 & bongiovimatthew-microsoft
# Source : https://github.com/bongiovimatthew-microsoft/pscredentialWithCert/issues/1
# Added a few assemblies and fixed a bug with ActiveClient not triggering properly. -Drew, This should now work in GUI Scripts.
